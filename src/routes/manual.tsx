...
import { Edit3, Calendar, MapPin, Car, Gift, Heart, Sparkles, Camera, Music, Cake, Utensils, Shirt, Church } from "lucide-react";
  ...
  return (
    <AppShell>
      <section className="px-6 pt-10 text-center">
        ...
        <h1 className="mt-4 font-display text-[44px] leading-none text-[var(--cocoa)]">
        ...
        <Link
          to="/manual/editar"
          className="mt-5 inline-flex items-center gap-1.5 rounded-full border border-[var(--gold)]/40 bg-white/60 px-3 py-1.5 text-[10px] font-serif-caps text-[var(--gold-deep)] hover:bg-white"
        >
      ...
      {loading && <p className="mt-4 text-center text-xs text-[var(--cocoa)]/40">Carregando…</p>}
