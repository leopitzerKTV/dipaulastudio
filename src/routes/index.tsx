  ...
  head: () => ({
    meta: [
      { title: "Amanda & Ricardo — Nosso Convite" },
      {
        name: "description",
        content:
          "Convite digital personalizado: confirme sua presença, veja a linha do tempo do casal e mais.",
      },
      { property: "og:title", content: "Amanda & Ricardo — Nosso Convite" },
      {
        property: "og:description",
        content: "Convite digital personalizado, álbum colaborativo e linha do tempo do casal.",
      },
    ],
  }),
  component: Index,
    ...
    <AppShell>
      ...
      <section className="relative px-6 pt-10">
        <div className="text-center">
          ...
          <p className="mt-5 font-display text-sm italic text-[var(--cocoa)]/70">
          ...
          >
            Amanda
            <span className="block font-display italic text-[42px] text-[var(--gold-deep)] my-1">
              e
            </span>
            Ricardo
          </motion.h1>
      ...
      <section className="mt-10 px-6">
        <Ornament />
        <h2 className="mt-5 text-center font-display text-3xl text-[var(--cocoa)]">
          Tudo do nosso casamento
        </h2>
        <p className="mt-2 text-center text-sm text-[var(--cocoa)]/65">
        ...
        <div className="mt-6 grid gap-3">
          <ActionCard
            ...
            sub="O começo, o pedido, o agora"
          />
          <ActionCard
            to="/linha-do-tempo"
            Icon={Calendar}
            title="Linha do Tempo"
            sub="Pedido, casamento, festa, lua de mel"
          />
          <ActionCard
            to="/album"
            Icon={Mail}
            title="Álbum Colaborativo"
            sub="Fotos dos convidados em tempo real"
          />
          <ActionCard
            to="/manual"
            Icon={BookOpen}
            title="Manual do Convidado"
            sub="Dress code, cerimônia, recepção e mais"
          />
          <ActionCard
            to="/editor"
            Icon={Wand2}
            title="Editor do Convite"
            sub="Personalize nomes, data, cores e imagem"
          />
          <ActionCard
            to="/painel"
            Icon={Gift}
            title="Painel Privado do Casal"
            sub="RSVP, presentes, mensagens"
          />
        </div>
      </section>
          ...
          <div className="mt-4 flex flex-col items-center gap-3">
            <div className="w-full">
              <label
                ...
                className="block text-left text-[10px] text-[var(--cocoa)]/60"
              >
      ...
      <p className="mt-10 text-center font-serif-caps text-[10px] text-[var(--gold-deep)]/70">
        Nossa História · App de Casamento
      </p>
    </AppShell>
  );
}
...
function ActionCard({
  ...
  return (
    <Link
      to={to}
      className="group flex items-center gap-4 rounded-2xl border border-[var(--gold)]/25 bg-[var(--card)] p-4 shadow-[var(--shadow-card)] transition-all hover:-translate-y-0.5 hover:border-[var(--gold)]/60"
    >
      ...
      <span className="font-serif-caps text-[10px] text-[var(--gold-deep)] opacity-0 transition-opacity group-hover:opacity-100">
        abrir
      </span>
    </Link>
  );
