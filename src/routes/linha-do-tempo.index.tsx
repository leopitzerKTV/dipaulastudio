...
const milestones = [
  { id: "f1", position: 0, storage_path: null, Icon: Gem, title: "Pedido de Casamento", date_label: "12 · Mai · 2023", imageUrl: proposal },
  { id: "f2", position: 1, storage_path: null, Icon: Sparkles, title: "Nosso Casamento", date_label: "24 · Mai · 2025", imageUrl: ceremony },
  { id: "f3", position: 2, storage_path: null, Icon: PartyPopper, title: "A Festa", date_label: "24 · Mai · 2025", imageUrl: party },
  { id: "f4", position: 3, storage_path: null, Icon: Plane, title: "Lua de Mel", date_label: "27 · Mai · 2025", imageUrl: honeymoon },
];
...
function Timeline() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      setItems(rows.map((r, i) => ({ ...r, Icon: icons[i % icons.length], imageUrl: r.storage_path ? urlMap.get(r.storage_path) : undefined })));
    }
    load();
            ...
            >
              ...
              <div className="flex flex-1 items-center gap-3 rounded-2xl border border-[var(--gold)]/25 bg-[var(--card)] p-2 pr-4 shadow-[var(--shadow-card)]">
                <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-xl">
                  {m.imageUrl ? (
                    <img src={m.imageUrl} alt={m.title} className="h-full w-full object-cover" loading="lazy" width={896} height={1600} />
                  ) : (
                    <div className="grid h-full w-full place-items-center bg-[var(--ivory)] font-serif-caps text-[9px] text-[var(--cocoa)]/40">Sem foto</div>
                  )}
                </div>
